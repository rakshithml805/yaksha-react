...
export default function OrderTheSequence() {
    ...
    <>
      <Grid item xs={4}>
        <Box sx={{minHeight:'750px'}}>
          <Typography variant="h2">Order the Sequence</Typography>
                ...
                <Grid container rowGap={3}>
                  ...
                  <Grid item xs>
                    {fields.length <= maxFields + 2 && (
                      <Button variant="outlined" onClick={addField}>ADD OPTIONS</Button>
                    )}
                  </Grid>
                </Grid>
              </Box>
