...
import { Container, Box, Typography,FormControl,InputLabel,OutlinedInput,
    Checkbox,Switch,InputAdornment,IconButton,Table,TableBody,TablePagination, Stack,
    TableCell,TableContainer,TableHead,TableRow,TableSortLabel, TableFooter } from '@mui/material';
                            ...
                            {visibleRows.map((tenant, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="center">
                                            <Switch checked={tenant.status === 'active' ? true : false}/>
                                        </TableCell>
                                        <TableCell align="center">
